...
public class VictoryManager : MonoBehaviour
{
    ...
    [SerializeField] private GameObject musicRequesterGO; // NUEVO
    ...
    private IEnumerator FadeOutMusic(float duration)
    {
        ...
        // Desactivar el objeto que contiene la playlist del nivel
        if (musicRequesterGO != null)
        {
            musicRequesterGO.SetActive(false);
        }
    }
